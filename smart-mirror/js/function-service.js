var FUNCTIONSERVICE = {
	defaultHome : function($scope) {
        ...
        if(responsiveVoice.voiceSupport()) {
          responsiveVoice.speak("메인화면으로 이동합니다.","Korean Female");
        }
        $scope.focus = "default";
	},
	whoIsSmartMirror : function($scope) {
		...
		if(responsiveVoice.voiceSupport()) {
	          responsiveVoice.speak("저는 멘헤라 프로젝트, 연습용 스마트 미러입니다.","Korean Female");
        }
	...
	wake : function($scope) {
		...
		if(responsiveVoice.voiceSupport()) {
            responsiveVoice.speak("안녕하세요. 마스터!","Korean Female");
          }
    	$scope.focus = "default";
	},
	whatCanISay : function($scope){
        ...
        if(responsiveVoice.voiceSupport()) {
          responsiveVoice.speak("이용 가능한 메뉴입니다.","Korean Female");
        }
	...
	lightOn : function() {
    	...
    	if(responsiveVoice.voiceSupport()) {
            responsiveVoice.speak("전원을 켭니다.","Korean Female");
        }
	...
	lightOff : function() {
		...
		if(responsiveVoice.voiceSupport()) {
            responsiveVoice.speak("전원을 끕니다.","Korean Female");
        }
